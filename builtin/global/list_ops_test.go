...
func TestList_filter(t *testing.T) {
	...
	t.Run("should return empty list", func(t *testing.T) {
		...
		assert.Equal(t, base.NewConventionalList(nil), result)
	})
...
func TestList_parseRunesToString(t *testing.T) {
	...
	t.Run("should parse empty list", func(t *testing.T) {
		result := parseRunesToStringMutator.Mutate(base.NewNamedOneLayerObject(parseRunesToStringMutator.Name(), []base.Node{
			base.NewConventionalList([]base.Node{}),
		}))
		assert.Equal(t, resultStruct(base.NewString(""), base.NewConventionalList(nil)), result)
	})

	t.Run("should parse list with non-rune", func(t *testing.T) {
		result := parseRunesToStringMutator.Mutate(base.NewNamedOneLayerObject(parseRunesToStringMutator.Name(), []base.Node{
			base.NewConventionalList([]base.Node{base.NewTag("x")}),
		}))
		assert.Equal(t, resultStruct(base.NewString(""), base.NewConventionalList([]base.Node{base.NewTag("x")})), result)
	})

	t.Run("should parse list with runes", func(t *testing.T) {
		result := parseRunesToStringMutator.Mutate(base.NewNamedOneLayerObject(parseRunesToStringMutator.Name(), []base.Node{
			base.NewConventionalList([]base.Node{base.NewRune('x'), base.NewRune('y')}),
		}))
		assert.Equal(t, resultStruct(base.NewString("xy"), base.NewConventionalList(nil)), result)
	})

	t.Run("should parse list with runes and non-runes", func(t *testing.T) {
		result := parseRunesToStringMutator.Mutate(base.NewNamedOneLayerObject(parseRunesToStringMutator.Name(), []base.Node{
			base.NewConventionalList([]base.Node{base.NewRune('x'), base.NewRune('y'), base.NewNumberFromString("123"), base.NewBoolean(true)}),
		}))
		assert.Equal(t, resultStruct(base.NewString("xy"), base.NewConventionalList([]base.Node{base.NewNumberFromString("123"), base.NewBoolean(true)})), result)
	})
}
