...
var mergeRule = tuple.Fn3(func(p stPattern.NamedRule, _ psBase.Character, r stResult.Node) base.Rule {
	return base.NewRule(p, r)
})

var ActiveRule = ps.RsMap(mergeActiveRule, psBase.RsSpaceSeparated2(psBase.RsAtSign, Rule))

var mergeActiveRule = tuple.Fn2(func(_ psBase.Character, r base.Rule) base.ActiveRule {
	return base.NewActiveRule(r.Pattern(), r.Result())
})
